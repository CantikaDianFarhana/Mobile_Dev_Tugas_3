                          ...
                          InkWell(
                            onTap: () {
                              final cake = Cake(
                                ...
                                description: 'Kue ulang tahun dengan krim putih bergelombang dan lilin berw,arna pink, tampil manis dan klasik',
                              );
                              Navigator.pushNamed(
                                context,
                          ...
                          InkWell(
                            onTap: () {
                              final cake = Cake(
                                ...
                                description: 'Kue klasik dengan topping stroberi segar, krim pink lembut, dan hiasan sprinkle, tampil sederhana namun manis.'
                                    ,
                              );
                              Navigator.pushNamed(
                                context,
                          ...
                          InkWell(
                            onTap: () {
                              final cake = Cake(
                                ...
                                description: 'Kue dua  dengan lapisan krim putih, dihiasi stroberi segar dan lilin, memberi kesan manis dan segar.',
                              );
                              Navigator.pushNamed(
                                context,
                                DetailHome.routeName,
                          ...
                          InkWell(
                            onTap: () {
                              final cake = Cake(
                                ...
                                description: 'Wedding cake elegan dengan mawar pink lembut, dihiasi tetesan krim putih yang memberikan kesan romantis dan manis',
                              );
                              Navigator.pushNamed(
                                context,
                                DetailHome.routeName,
